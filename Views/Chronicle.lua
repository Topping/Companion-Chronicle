...
function Chronicle:Create()
    ...
    Rule(self.details, 0, -100, 350)
    Ink(self.details, "WHAT IS REMEMBERED", 0, -106, 230, 24, 10)
    ...
    self.forget = Link(self.details, "Forget character", 0, -426, 163, function() C:Forget() end)
